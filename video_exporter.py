...
class VideoExporter(object):
    ...
    def __init__(self, callback=None, queue_maxlen=1000):
        """
    ...
    def clear_complete_tasks(self):
        ...
        try:
            for task in host.archive_export_tasks_get():
                if task["state"] in self.cancel_task_with_states:
